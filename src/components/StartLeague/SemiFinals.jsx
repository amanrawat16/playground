...
function SemiFinals({ semiFinalTeams }) {
    ...
    const handleteamdeleteMatch1 = () => {

    }

    const handleteamdeleteMatch2 = () => {

    }

    const handleStartSemimatches = (data) => {
        console.log(data)
    }
                ...
                semiFinalTeams.length > 0 ?
                        ...
                        <div className='w-1/3 border  my-10 rounded px-4 py-5 shadow-lg mx-auto'>
                            <table className='w-full text-center'>
                                ...
                                <tbody className='text-center'>
                                    {
                                        semiFinalTeams.map((match, index) => {
                    ...
                    <div className='w-full h-32 flex justify-center items-center'>
                        <h1 className='text-center font-bold text-xl text-slate-600'>
                            QuaterFinal Matches results have not been calculated yet
                        </h1>
                    </div>
            }
